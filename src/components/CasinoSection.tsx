  ...
  <section className="border-y hairline bg-card/30">
    <div className="container py-16">
      <div className="flex items-end justify-between mb-8">
        ...
        <a href="/games" className="hidden md:inline-flex text-sm text-foreground/70 hover:text-gold transition-colors">All games →</a>
      </div>
      ...
      <div className="text-center mt-8">
        <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex px-6 h-11 rounded-md border hairline text-foreground hover:border-gold/50 hover:text-gold font-medium text-sm transition-colors">
