  ...
  <section className="container py-16">
    <div className="relative rounded-lg overflow-hidden border hairline bg-card/40 p-10 md:p-16 text-center">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 h-12 rounded-md bg-gold text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity">
